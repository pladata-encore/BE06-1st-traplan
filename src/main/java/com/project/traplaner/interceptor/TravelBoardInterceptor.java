package com.project.traplaner.interceptor;
...
import static com.project.traplaner.util.LoginUtils.isLogin;
import static com.project.traplaner.util.LoginUtils.isMine;

@Configuration
@RequiredArgsConstructor
@Slf4j
public class TravelBoardInterceptor implements HandlerInterceptor {


    // 여기 인터셉터에서 Board쪽 DB 조회가 필요해서 주입을 좀 받겠다.
    private final TravelBoardMapper boardMapper;
